...
export const BLOG_CATEGORIES: BlogCategory[] = [
  {
    ...
    icon: 'calculator',
    metaTitle: 'Percentage Basics – Tutorials & Guides | PercentLab Blog',
  ...
  },
  {
    ...
    icon: 'dollar-sign',
    metaTitle: 'Finance & Money Percentage Guides | PercentLab Blog',
  ...
  },
  {
    ...
    icon: 'graduation-cap',
    metaTitle: 'Education & Grade Percentage Tutorials | PercentLab Blog',
  ...
  },
  {
    ...
    icon: 'shopping-cart',
    metaTitle: 'Shopping & Discount Percentage Guides | PercentLab Blog',
